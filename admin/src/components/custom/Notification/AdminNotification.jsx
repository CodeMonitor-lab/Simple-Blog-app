        ...
        <div className="flex items-start">
          ...
          <div>
            ...
            <p className="text-sm text-blue-700 mt-1">
              Configure how and when you receive notifications about your blog
              activity.
            </p>
          </div>
        </div>
        ...
        <div className="flex items-start">
          ...
          <div>
            ...
            <p className="text-sm text-yellow-700 mt-1">
              ...
              <span className="font-medium">admin@myblog.com</span>. You can
              change this in General Settings.
            </p>
          </div>
        </div>
      </div>
